    ...
    <section id="about" className="theme-light bg-paper py-24 sm:py-32">
      <div className="container-page">
        <SplitHeading
          text="About"
          as="h2"
          className="mb-10 text-center font-display text-[11vw] font-bold uppercase leading-[0.95] tracking-tight text-accent-stroke sm:mb-14 sm:text-7xl md:text-8xl"
        />
